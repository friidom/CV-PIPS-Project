  ...
  return (
    <PlaybackProvider>
      <div className="mx-auto max-w-[1320px] px-4 py-10 sm:py-14">
        <Section
          eyebrow="Live demo"
          title="Upload a clip, get its events back"
          lead={
            <>
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-[minmax(0,1fr)_330px]">
            ...
            {result && (
              <>
                ...
                <Panel className="p-4">
                  ...
                  <RiskCurve risk={result.risk} duration={result.meta.duration} />
                </Panel>
              </>
            )}
          </div>
